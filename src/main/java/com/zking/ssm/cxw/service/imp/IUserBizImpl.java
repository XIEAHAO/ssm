...
import com.zking.ssm.cxw.mapper.UserMapper;
...
public class IUserBizImpl implements IUserBiz {
    ...
    public String selectById(User record) {
        ...
        }else if(null != u && PasswordHelper.checkCredentials(record.getUserPassword(), u.getUserSalt(), u.getUserPassword()) && u.getUserFlag()==0){
            message = "该用户已被禁用，请与管理员联系";
        }else if(null != u && PasswordHelper.checkCredentials(record.getUserPassword(), u.getUserSalt(), u.getUserPassword()) && u.getUserFlag()==1){
