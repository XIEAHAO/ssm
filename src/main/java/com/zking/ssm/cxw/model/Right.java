package com.zking.ssm.cxw.model;
...
public class Right {
    ...
    public Right(String rightCode, String rightParentCode, String rightText, String rightUrl, String rightTip, String rightPermission,List<Right> rlist) {
